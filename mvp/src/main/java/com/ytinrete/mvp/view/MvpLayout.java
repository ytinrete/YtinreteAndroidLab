 ...
 */
public class MvpLayout<P extends Presenter> extends FrameLayout implements ViewWithPresenter<P> {
  ...
  public MvpLayout(Context context, AttributeSet attrs, int defStyle) {
